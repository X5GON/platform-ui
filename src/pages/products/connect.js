      ...
      <div className="bg-white p-128 maxer mx-auto connect">
        <div className="mx-lg-1 px-4">
          <h4 className="maxer-880 pb-128 mb-0 text-purple">
            Use our easy to install Moodle plugin to enable the integration of
            different X5GON features within any Moodle LMS. Make easy and simple
            the control and the​ integration of X5GON 'User Activity
            Acquisition' library by managing the call and the activation of our
            services in the right Moodle courses pages. As a result, we will be
            notified about the exact accesses made on the OERs embedded in open
            courses.
          </h4>
      ...
      <div className="text-purple maxer-880 api tokenapi">
        <div id="oer-provider-token" class="resource">
          <p class="form-text">
            ...
            particular user has accessed. The token is provided after a provider
            has successfully registered to the OER Network.
          </p>
        </div>
      </div>
    );
    ...
    return (
      <div className="text-purple maxer-880 api baseapi">
        <div id="oer-provider-library" class="resource">
          ...
          <pre class="mb-4 code-block language-handlebars">
            <span class="token tag">
              <span class="token tag">
              ...
              <span class="token attr-value">
                <span class="token punctuation">=</span>
                <span class="token punctuation">"</span>
                https://platform.x5gon.org/api/v1/snippet/latest/x5gon-log.min.js
                <span class="token punctuation">"</span>
              </span>
              ...
              <span class="token attr-value">
                <span class="token punctuation">=</span>
                <span class="token punctuation">"</span>
                sha384-ZfzlS43MMnlhhaZGNiNLYUcwbS+ndioybwxGNvzEFR7XcaLun22bDz+tCvCUWfq0
                <span class="token punctuation">"</span>
              </span>
            ...
            <span class="token script language-javascript"></span>
            <span class="token tag">
              <span class="token tag">
                <span class="token punctuation">&lt;/</span>script
              </span>
          ...
          <pre class="code-block language-handlebars">
            <span class="token tag">
              <span class="token tag">
                <span class="token punctuation">&lt;</span>script
              </span>{" "}
              ...
              <span class="token attr-value">
                <span class="token punctuation">=</span>
                <span class="token punctuation">"</span>
                https://platform.x5gon.org/api/v1/snippet/v2/x5gon-log.min.js
                <span class="token punctuation">"</span>
              </span>
              <span class="token attr-name">integrity</span>
              <span class="token attr-value">
        ...
        <div className="enable">
          ...
          <pre class="mb-3 language-javascript code-block">
            <span class="token function">x5gonActivityTracker</span>
            <span class="token punctuation">(</span>
            <span class="token string">'token'</span>
            <span class="token punctuation">,</span> testingEnvironment
            <span class="token punctuation">)</span>
            <span class="token punctuation">;</span>
          </pre>
          ...
          <p>
            ...
            and <code>testingEnvironment</code> is a boolean value indicating if
            the function is used for testing. Once in production, this variable
            can be omited.
          </p>
          <p className="p2">
              ...
              <span className="token script language-javascript">
                ...
                <span className="token template-string">
                  <span className="token string">
                    ...
                    {"          "}we use cookies to deliver personalized,
                    responsive services and to improve the site.{"\n"}
                    {"          "}This is done in collaboration with the X5GON
                    project.`
                  </span>
                </span>
                <span className="token punctuation">,</span>
                ...
                <span className="token keyword">if</span>{" "}
                <span className="token punctuation">(</span>
                <span className="token keyword">typeof</span>{" "}
                x5gonActivityTracker <span className="token operator">!==</span>{" "}
    ...
    return (
      <div className="text-purple maxer-880">
        ...
        <p>
          ...
          <Link to="/join#form">application-form</Link> site.
        </p>
        <p>
